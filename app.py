...
class App:
    def __init__(self, window, window_title, video_source = 0):
        ...
        self.window.geometry('{}x{}'.format(460, 350))
        ...
        self.ctr_end = tkinter.Frame(window, bg ='orange', width=200, height=200, padx=3, pady=3)

        self.video_source = video_source
        self.vidLeft = MyVideoCapture(video_source)
