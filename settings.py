...
class Settings:
    ...
    def volumeControl(self):
        ...
        volumeLabel.grid(row = 3, column = 0)
        volumeInput.grid(row = 3, column = 1, columnspan = 3, pady = 5)
    ...
    def parameterControls(self):
        ...
        parameterOneLabel.grid(row = 4, column = 0)
        parameterOne.grid(row = 4, column = 1, columnspan = 8, pady = 5)
        parameterTwoLabel.grid(row = 5, column = 0)
        parameterTwo.grid(row = 5, column = 1, columnspan = 8, pady = 5)